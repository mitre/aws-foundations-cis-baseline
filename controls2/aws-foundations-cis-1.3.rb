...
control "aws-foundations-cis-1.3" do
  ...
  desc "The AWS support portal allows account owners to establish security questions that can be used 
...
that security questions be established. "
  desc "rationale", "When creating a new AWS account, a default super user is automatically created. This account 
