...
analyzes only policies that are applied to resources in the same AWS Region. "
  desc "rationale", "AWS IAM Access Analyzer helps you identify the resources in your organization and accounts, 
...
only when the account you use has the necessary permissions. "
  desc "additional_information", "Some regions in AWS are enabled by default and some are disabled by default. Regions 
