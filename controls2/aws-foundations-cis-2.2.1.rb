...
supported. "
  desc "rationale", "Encrypting data at rest reduces the likelihood that it is unintentionally exposed and can 
...
**Note:** EBS volume encryption is configured per region. "
  desc "additional_information", "Default EBS volume encryption only applies to newly created EBS volumes. Existing EBS 
volumes are **not** converted automatically. "
  desc "impact", "Losing access or removing the KMS key in use by the EBS volumes will result in no longer being 
