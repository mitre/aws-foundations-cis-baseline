...
automatically provide an inventory of Amazon S3 buckets. "
  desc "rationale", "Using a Cloud service or 3rd Party software to continuously monitor and automate the process 
...
matching to discover and protect your sensitive data in AWS. "
  desc "check", "Perform the following steps to determine if Macie is running:
...
are using a 3rd Party tool to manage and protect your s3 data you meet this recommendation. "
  desc "fix", "Perform the steps below to enable and configure Amazon Macie
...
implementing and configuring that tool. "
  desc "impact", "There is a cost associated with using Amazon Macie. There is also typically a cost associated 
