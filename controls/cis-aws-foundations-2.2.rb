...
[https://console.aws.amazon.com/cloudtrail](https://console.aws.amazon.com/cloudtrail)
    ...
    - Under the `S3` section, ensure `Enable log file validation` is set to
`Yes`
...
[https://console.aws.amazon.com/cloudtrail](https://console.aws.amazon.com/cloudtrail)
    ...
    ```
    Note that periodic validation of logs using these digests can be performed
...
CONTROL:6 DESCRIPTION:Maintenance, Monitoring and Analysis of Audit Logs;"
  tag ref:
"http://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-log-file-validation-enabling.html:CIS
CSC v6.0 #6.3"
end
