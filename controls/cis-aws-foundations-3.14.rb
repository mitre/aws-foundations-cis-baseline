...
VPC changes and the `` taken from audit step 1.
    ```
...
($.eventName = RejectVpcPeeringConnection) || ($.eventName =
AttachClassicLinkVpc) || ($.eventName = DetachClassicLinkVpc) || ($.eventName =
...
--alarm-actions
  ...
  tag comment: nil
  tag cis_controls: "TITLE:Implement Automated Configuration Monitoring Systems
CONTROL:5.5 DESCRIPTION:Utilize a Security Content Automation Protocol (SCAP)
compliant configuration monitoring system to verify all security configuration
