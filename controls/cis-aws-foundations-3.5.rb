...
established for detecting changes to CloudTrail's configurations."
  desc  "rationale", "Monitoring changes to CloudTrail's configuration will
help ensure sustained visibility to activities performed in the AWS account."
  desc  "check", "
...
cloudtrail configuration changes and the `` taken from audit step 1.
    ```
...
= CreateTrail) || ($.eventName = UpdateTrail) || ($.eventName = DeleteTrail) ||
