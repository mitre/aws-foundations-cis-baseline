...
with AWS partner security products. "
  desc "rationale", "AWS Security Hub provides you with a comprehensive view of your security state in AWS and helps 
...
enabling you to quickly assess the security posture across your AWS accounts. "
  desc "check", "The process to evaluate AWS Security Hub configuration per region 
...
Hub
``` "
  desc "fix", "To grant the permissions required to enable Security Hub, attach the Security Hub managed 
...
``` "
  desc "impact", "It is recommended AWS Security Hub be enabled in all regions. AWS Security Hub requires AWS 
