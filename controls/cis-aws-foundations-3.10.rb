...
and alarm be established changes to Security Groups."
  desc  "rationale", "Monitoring changes to security group will help ensure
that resources and services are not unintentionally exposed."
  desc  "check", "
...
security groups changes and the `` taken from audit step 1.
    ```
