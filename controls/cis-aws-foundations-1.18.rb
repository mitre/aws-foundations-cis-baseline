...
information be provided."
  desc  "rationale", "Specifying security-specific contact information will
...
organization that is best equipped to respond to them."
  desc  "check", "
    Perform the following in the AWS Management Console to determine if
security contact information is present:
