...
recommended that CMK key rotation be enabled."
  desc  "rationale", "Rotating encryption keys helps reduce the potential
impact of a compromised key as data encrypted with a new key cannot be accessed
with a previous key that may have been exposed."
  desc  "check", "
...
CONTROL:6 DESCRIPTION:Maintenance, Monitoring and Analysis of Audit Logs;"
  tag ref:
"https://aws.amazon.com/kms/pricing/:http://csrc.nist.gov/publications/nistpubs/800-57/sp800-57_part1_rev3_general.pdf"
end
