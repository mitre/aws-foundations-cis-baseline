...
AWS Management Console sign-in without MFA and the `` taken from audit step 1.
    ```
...
DESCRIPTION:Account Monitoring and Control;"
  tag ref:
"http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/viewing_metrics_with_cloudwatch.html:CIS
CSC v6.0
