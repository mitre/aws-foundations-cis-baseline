...
control "3.3" do
  title "Ensure a log metric filter and alarm exist for usage of \"root\"
account"
...
established for root login attempts."
  desc  "rationale", "Monitoring for root account logins will provide
visibility into the use of a fully privileged account and an opportunity to
reduce the use of it."
  desc  "check", "
...
\"Root\" account usage and the `` taken from audit step 1.
    ```
...
--alarm-actions
  ...
  tag comment: nil
  tag cis_controls: "TITLE:Log and Alert on Unsuccessful Administrative Account
Login CONTROL:4.9 DESCRIPTION:Configure systems to issue a log entry and alert
on unsuccessful logins to an administrative account.;"
  tag ref: "CIS CSC v6.0 #4.6, #5.1,
#5.5:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/receive-cloudtrail-log-files-from-multiple-regions.html:https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.html:https://docs.aws.amazon.com/sns/latest/dg/SubscribeTopic.html"
end
